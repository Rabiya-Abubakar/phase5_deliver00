      ...
      <div style={{ marginBottom: "20px" }}>
        <button
          style={{
            ...
            cursor: "pointer", 
            borderRadius: "5px",
            backgroundColor: activeButton === "" ? " #00ce9a" : "#f4f4f4", // Blue for active
        ...
        <button
          ...
          style={{
            ...
            cursor: "pointer", 
            borderRadius: "5px", 
            backgroundColor: activeButton === "delivered" ? " rgb(0, 194, 0)" : "#f4f4f4",  
        ...
        <button
          ...
          style={{
            ...
            cursor: "pointer", 
            borderRadius: "5px", 
            backgroundColor: activeButton === "pending" ? " rgb(219, 219, 20)" : "#f4f4f4", // Blue for active
        ...
        <button
          ...
          style={{
            ...
            cursor: "pointer", 
            borderRadius: "5px", 
            backgroundColor: activeButton === "canceled" ? " red" : "#f4f4f4", // Blue for active
            color: activeButton === "canceled" ? "white   " : "black",
          }}
